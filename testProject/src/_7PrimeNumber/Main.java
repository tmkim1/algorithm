...
/**
 * [소수 구하기]
 * 설명: N 까지의 소수를 구하는 경우, N의 제곱근 이하의 숫자 중에서 
 * 2~N의 제곱근 중 자기 자신을 제외한 배수의 숫자를 제외 시킨다. 
 * ex) N = 100
 * 2 ~ 10(100의 제곱근) 
 * 2 자기 자신은 제외--> 3 ~ 100까지 2의 배수에 속하는 숫자들은 소수가 아님 제거 
 * 3 자기 자신은 제외--> 4 ~ 100까지 3의 배수에 속하는 숫자들은 소수가 아님 제거
 * (0, 1은 소수가 아니기 때문에 제외) 
 * 
